...
import {
    ...
    MiddleUserProfile, RightUserProfile, ButtonUserProfile, RightWrapper, ParaWrapper
...
class CommentUserProfile extends React.Component {
    state = {
        button: true
    }
    onClickEditProfile = () =>{
...
export default withRouter(connect()(CommentUserProfile));
