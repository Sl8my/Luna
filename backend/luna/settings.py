...
SECRET_KEY = 'x3vz(@_a7_at+-af8)4&-n7+-((sim&sa&)k%ly894630056a1'
...
#DEFAULT_FROM_EMAIL = ast.literal_eval(os.environ.get('DEFAULT_FROM_EMAIL'))
#EMAIL_USE_TLS = ast.literal_eval(os.environ.get('EMAIL_USE_TLS'))
#EMAIL_HOST = ast.literal_eval(os.environ.get('EMAIL_HOST'))
#EMAIL_HOST_USER = ast.literal_eval(os.environ.get('EMAIL_HOST_USER'))
#EMAIL_HOST_PASSWORD = ast.literal_eval(os.environ.get('EMAIL_HOST_PASSWORD'))
